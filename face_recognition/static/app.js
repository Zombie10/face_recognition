...
$(document).ready(function(){
    ...
    $('#train').submit(function(event){
        ...
        if(train_data.name && train_data.file){
            ...
            axios.post('/api/train', train_form_data).then(function(response){
                ...
                message = {type: 'success', message: 'El entrenamiento se ha realizado, el usuario con id es: ' + _.get(response, 'data.id')};
            ...
            message = {type: "error", message: "Se requiere nombre e imagen de la cara."}
    ...
    $('#recognize').submit(function(e){
        ...
        axios.post('/api/recognize', recog_form_data).then(function(response){
            ...
            console.log("Encontramos a un usuario emparejado con tu imagen de cara y es", response.data);

            message = {type: 'success', message: 'Encontramos a un usuario emparejado con tu imagen de cara y es: '+ response.data.user.name};
